...
; The code below corresponds almost 1:1 to the following data fragment program.
; However, it has explicit returns (first generalization step.)
;
    ...
    ((p-pairnatnat #s(pair-nat-nat) ((p-succ #s(nat) ((p-var #s(nat) () () ())) () ()) (p-var #s(nat) () () ())) () ())
     (primitive-return
      ...
      (primitive-apply
       ...
       (primitive-fun
        #s(nat) #s(nat)
        (((p-var #s(nat) () () ()) (primitive-return #s(nat) (primitive-const (succ #s(nat) ((var #s(nat) 0 () ())) () ()))))))
